...
\subsection{Future Applications and Interaction}

\paragraph{Interaction and user modeling.}
One downstream application concerns Theory-of-Mind-like behavior in AI systems. On the present account, such behavior can be understood as projection-sensitive modeling of another agent's representation: what the agent observes, assumes, wants, intends, or cannot distinguish. This does not require treating the system as having humanlike inner experience. It treats user modeling as another case of reasoning under projection, where claims about another agent's beliefs, goals, or emotional state should be marked according to whether they are preserved, reconstructable, traceable, or opaque.
